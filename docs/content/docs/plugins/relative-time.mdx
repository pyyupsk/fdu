...
<Callout type="warn">
**Locale Support**: The `locale` option is not yet implemented. All output is currently in English regardless of the `locale` setting. Internationalization support is planned for a future release.
</Callout>
