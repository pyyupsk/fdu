...
- `pattern: string` - Format pattern using tokens (see [Format Tokens](/docs/format-tokens))
...
For a complete list of available format tokens, see the [Format Tokens](/docs/format-tokens) guide.
