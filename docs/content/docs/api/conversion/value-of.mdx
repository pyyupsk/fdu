---
title: valueOf()
description: Master the valueOf() method to get Unix timestamps in milliseconds since epoch (January 1, 1970). Learn numeric date comparison, performance measurement, timestamp storage, cache key generation, random date generation, date sorting, and implicit type conversion with practical examples.
---
...
```typescript
const dates = [fdu("2024-03-15"), fdu("2024-01-20"), fdu("2024-02-10")];
