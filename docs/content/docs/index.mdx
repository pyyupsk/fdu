...
```typescript
import { registerLocale, locale } from "@pyyupsk/fdu";
...
- **Locale support** - 11 built-in locales
- **Chainable API** - Fluent method chaining
- **Tree-shakable** - Import only what you need

## Next Steps

- [Formatting Guide](/docs/formatting) - Learn about format tokens
- [Localization](/docs/localization) - Use different locales
- [API Reference](/docs/api-creation/fdu) - Complete API documentation
