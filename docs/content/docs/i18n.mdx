...
description: Comprehensive guide to internationalization in @pyyupsk/fdu. Learn how to register locales for Spanish, French, German, Japanese, Chinese and more, format dates in multiple languages, create custom locale configurations, and implement locale-aware date formatting for global applications with week start customization.
---
