...
Thank you for considering contributing to `fd`! This document provides guidelines and instructions for contributing.
...
git clone https://github.com/pyyupsk/fd.git
cd fd
...
- Bundle size must remain <2KB gzipped
...
describe("Performance", () => {
  bench("fd - format YYYY-MM-DD", () => {
    fd("2025-01-01")!.format("YYYY-MM-DD");
  });
...
- **Issues**: <https://github.com/pyyupsk/fd/issues>
- **Discussions**: <https://github.com/pyyupsk/fd/discussions>
- **Email**: <contact@fasu.dev>

## License

By contributing to `fd`, you agree that your contributions will be licensed under the MIT License.
